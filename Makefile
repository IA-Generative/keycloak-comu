...
dev: ## Start development environment (keycloak + dev + cleanup)
	docker compose -f ./docker/docker-compose.dev.yml up keycloak database mailhog -d; \
  pnpm run dev; \
	docker compose -f ./docker/docker-compose.dev.yml down

prod: ## Start development environment (keycloak + dev + cleanup)
	docker compose -f ./docker/docker-compose.prod.yml up keycloak database mailhog -d; \
  pnpm run preview; \
	docker compose -f ./docker/docker-compose.dev.yml down
